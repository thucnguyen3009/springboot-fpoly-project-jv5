						...
						<div class="container">
							<div class="d-flex justify-content-center h-100">
				                ...
				                <div class="card-body" style="width: auto;">
				                	<form:form class="row" action="/subpage/sendmailotp" method="POST" modelAttribute="sendGmailOtpFrm">
											...
											<div class="input-group form-group">
												<div class="input-group mb-3 input-group-prepend">
													...
													<div class="form-floating flex-grow-1">
														<form:input path="email" class="form-control" id="email" placeholder="Gmail Đã Đăng Ký" autocomplete="off"/>
														<label for="email">Gmail Đã Đăng Ký</label>
													</div>
												</div>
											</div>
