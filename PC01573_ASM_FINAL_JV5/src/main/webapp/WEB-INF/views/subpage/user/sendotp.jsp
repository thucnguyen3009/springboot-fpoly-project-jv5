						...
						<div class="container">
							<div class="d-flex justify-content-center h-100">
				                ...
				                <div class="card-body" style="width: auto;">
				                	<form:form class="row" action="/subpage/sendotp" method="POST" modelAttribute="otpFrm">
				                        	<div style="height: 15px; padding-bottom: 20px;">
				                        		<form:errors path="otp" element="div" />
				                        	</div>
											<div class="input-group form-group">
												<div class="input-group mb-3 input-group-prepend">
													...
													<div class="form-floating flex-grow-1">
														<form:input path="otp" class="form-control" id="otp" placeholder="Nhập Mã OTP" autocomplete="off"/>
														<label for="otp">Nhập Mã OTP</label>
													</div>
												</div>
											</div>
											<div class="input-group mb-3 input-group-prepend text-center">
												<a class="links" href="/botxxii/resendcode" style="margin: auto;">Gửi lại mã?</a>
											</div>
